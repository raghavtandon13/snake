...
Color green = {49, 81, 30, 255};
Color darkGreen = {26, 26, 25, 255};
int cellSize = 30;
int cellCount = 25;
...
bool ElemetInDeque(Vector2 element, deque<Vector2> deque) {
  ...
  public:
    ...
    void Draw() {
        DrawTexture(texture, offset + position.x * cellSize,
                    offset + position.y * cellSize, darkGreen);
    }
    ...
    Vector2 GenerateRandomPos(deque<Vector2> snakeBody) {
        ...
        while (ElemetInDeque(position, snakeBody)) {
...
class Game {
  public:
    ...
    void CheckCollisionWithTail() {
        ...
        if (ElemetInDeque(snake.body[0], headlessBody)) {
            GameOver();
        }
    }
    void GameOver() {
